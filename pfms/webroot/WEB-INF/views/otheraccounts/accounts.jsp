...
<body>
	...
	<span class="float-right"><a class="btn btn-default" href="<c:url value="/otheraccounts/addform" />" target="sys_content">
					新增
				</a></span>
